...
# Posicionamento centralizado
    x_loc1, y_loc1 = centralizar_texto(65.15, 293, dados["loc1"])
    x_desc1, y_desc1 = centralizar_texto(260.5, 293, dados["desc1"])
    x_qtd1, y_qtd1 = centralizar_texto(448.5, 293, dados["qtd1"])
    x_val1, y_val1 = centralizar_texto(531, 293, dados["val1"])
